...
def remove_from_watchlist(user_id, film_id):
    ...
    Mirrors remove_from_collection(): looks up the entry scoped to the user,
    raises if it isn't there, and otherwise deletes it.
...
def get_watchlist(user_id):
    ...
    Ordering matches get_collection() so the two feeds behave consistently.
